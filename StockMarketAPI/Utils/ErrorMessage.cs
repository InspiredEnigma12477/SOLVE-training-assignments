...
namespace StockMarketAPI.Utils
{
    ...
    public static class ErrorMessages
    {
        public static readonly Dictionary<int, ErrorMessage> Errors = new Dictionary<int, ErrorMessage>
        {
            ...
            { 127, new ErrorMessage { Code = 127, Message = "This is Not Supported Format, Expected {AVG,MIN,MAX}." } },
            { 128, new ErrorMessage { Code = 128, Message = "Failed to Update Stock Prices." } },
